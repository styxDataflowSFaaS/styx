...
For the OSDI 2023 submission, enter the `benchmark` folder and run the  `kafka_output_comsumer.py` as in the previous example. 
...
*   [`benchmark`](https://github.com/styxDataflowSFaaS/styx/tree/main/benchmark) 
    The benchmark we used for the experiments for the OSDI 2023 submission
...
*   [`plots`](https://github.com/styxDataflowSFaaS/styx/tree/main/plots)
    Code used for plots in the OSDI 2023 submission
